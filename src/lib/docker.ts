...
// --- Connection descriptor (UI "remote server" indicator) ---
 ...
 * TLS variables), without opening a connection. Returns a "local" descriptor
 * when no remote host is set or when the value points at a local socket /
 * named pipe.
 */
