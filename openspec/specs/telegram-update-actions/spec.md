...
Spec base: telegram-update-imagenes (full spec, archived at `openspec/changes/archive/2026-08-10-telegram-update-imagenes/`; last amended by change migrate-telegram-bot-api-v2). Archive target: `openspec/specs/telegram-update-actions/spec.md`.
